...
import {
    selectRequestParams,
    setRequestParams,
} from '@/5_entities/order/model/slice.ts';
...
export const ManagerMainPage = () => {
    ...
    const createOrderByPhoneNumberClickHandler = () => {
        navigate('/create-order-by-phone-number');
    };
    ...
    return (
        <div>
            ...
            >
                <div className={`text-[24px] md:text-[30px]`}>Ваши заказы</div>
                <div
                    className={
                ...
                >
                    ...
                    <div className={'min-w-44'}>
                        ...
                        />
                        <ButtonAddItem
                            text={'Создать заказ по номеру'}
                            clickHandler={createOrderByPhoneNumberClickHandler}
                        />
                    </div>
                </div>
            </div>
